...
<div align="center">
<img src="https://github-readme-stats-941kjws-projects.vercel.app/api?username=941kjw&show_icons=true&include_all_commits=true&count_private=true&theme=tokyonight&locale=en&hide_border=true" height="170" alt="stats graph" />
...
- Apple 및 Google 스토어 검증과 Webhook 멱등 처리를 포함한 **IAP 구매, 구독 및 크레딧 시스템** 개발
- S3 Presigned URL, 영속 작업 상태, RabbitMQ를 활용한 **음원→악보 비동기 변환 파이프라인** 구현
- 대용량 **AI 연습 리포트**의 배치 분할, 길이 초과 재시도 및 실패 복구 흐름 구축
...
- Java 25와 Spring Boot 4.1 기반 Arpe 백엔드 개발 및 운영
- IAP 구매, 구독 및 크레딧 원장의 멱등성, 동시성, 실패 복구 흐름 구현
...
- AI 음악 전사 서비스 백엔드 시스템 구현
- 실시간 관제 및 모니터링 시스템 개발
